...
Shader "LearningShaders/Basic/07_VertexColorTexturedVCStrength" {
...
_MainTex("MainTex",2D) = ""{}
[PowerSlider ] _VCStrength("Vertex Color Strentgh", Range (0,1)) = 0
...
i.color = i.color + _VCStrength;
return i.color * texCol; //return the final result that will be drawn
}
